...
public class StandardCostingMethod extends AbstractCostingMethod implements
	...
	public void setCostingMethod(MAcctSchema accountSchema, MTransaction transaction, IDocumentLine model,
		...
		this.dimension.setCurrentCostPrice(model.getPriceActual());
	...
	private void createCostDetail() {
		...
		System.out.println("dimension.getCurrentCostPrice()   " + dimension.getCurrentCostPrice());
		...
		updateAmountCost();
		costDetail.setCurrentCostPrice(model.getPriceActual());
		System.out.println("model.getPriceActual() :" + model.getPriceActual());
		costDetail.saveEx();
		// CostAms
