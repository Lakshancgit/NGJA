...
//java.util.Properties.AssayCertificateMultiple.processIt
public class AssayCertificateMultiple extends CalloutEngine {
		...
		public String processIt(Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value) {
			...
			if (ADialog.ask(WindowNo, null, "Process Confirmation", "Do I process this?")) {
				...
				int multipleCertificate_ID = 1000103;
				MProcess process = new MProcess(ctx, multipleCertificate_ID, mTab.getTrxInfo());
				
				
				ProcessInfo pi = new ProcessInfo("Multiple Certificate", multipleCertificate_ID, table_ID, record_ID);
